...
<html lang="en">
    ...
    <body>
        ...
        <main class="main">
                ...
                <div class="container">
                    <div class="row text-start">
                        <div class="col-12">
                            ...
                            <a href="{{ asset('brosur/Brosur.pdf') }}" download="Brosur.pdf"
                            ...
                            <div class="card shadow-lg mb-5 rounded">
                                ...
                                <div class="card-body">
                                    <div class="title">
                                        <div class="row row-cols-2">
                                            ...
                                            <div class="col-lg-12 col-12">
                                                <h4 class="card-text d-flex justify-content-end value-properti">Rp
                                                    96.000.000</h4>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button type="button" class="btn btn-outline-primary mt-4" data-bs-toggle="modal"
                                        data-bs-target="#nyobaModal" style="width: 100%;">Detail</button>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <p class="pt-2">Graha Samawa adalah perusahaan kontraktor dan pengembang properti. Graha
                                Samawa didirikan pada tahun 2025, seorang pengusaha muda yang memiliki banyak ide
                                inovatif dalam menciptakan kawasan hunian yang memadukan keindahan, keseimbangan
                                lingkungan, dan kenyamanan bagi penghuninya.</p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row align-items-stretch justify-content-between lokasi-item">
                        <div class="col-lg-6 d-flex align-items-center gmap_canvas">
                            <iframe class="gmap_iframe" frameborder="0" scrolling="no" marginheight="0"
                                marginwidth="0"
                                src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=bangil&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                        </div>
                        <!-- <style>
                        ...
                        <div class="col-lg-6 d-flex justify-content-center flex-column">
                            ...
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem eveniet
                                repudiandae necessitatibus numquam in eaque laudantium nam nulla fugiat hic.</p>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum perferendis blanditiis
                                ducimus ullam cupiditate corporis aliquam saepe, nostrum tempora ad.</p>
                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cupiditate eum, incidunt ut id
                                voluptatum accusantium, quas nemo perspiciatis odio alias sapiente earum unde saepe
                                repellendus?</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="sosmed d-flex align-items-center justify-content-center">
                            <a href="https://wa.me/62895366481314" target="_blank" class="me-5"><i
                                    class="fa-brands fa-whatsapp"></i><span> 0895366481314</span></a>
                            <a href="https://instagram.com/grahasamawa" target="_blank" class="me-5"><i
                                    class="fa-brands fa-instagram"></i><span> @grahasamawa</span></a>
                            <a href="https://www.facebook.com/share/1989vzbmwr/?mibextid=wwXIfr" target="_blank"><i
                                    class="fa-brands fa-facebook"></i> <span> Graha Samawa</span></a>
                        </div>
            ...
            <!-- MODAL -->
            <div class="modal fade" id="nyobaModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                            ...
                            <div class="row row-cols-2">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptates ad
                                        dignissimos nemo dolorem perferendis, tempore nisi veritatis quidem accusantium
                                        facere at omnis corporis porro sit culpa, beatae, tempora ratione nihil ullam
                                        magni? Temporibus, repudiandae fuga! Possimus vel quaerat et tempore ex in,
                                        error dolorem voluptas velit fuga nisi exercitationem unde nostrum sint
                                        consequuntur neque iure quasi cum ab cumque! Omnis repellat quas aspernatur
                                        aliquam laudantium debitis distinctio fugiat nostrum tenetur, delectus inventore
                                        obcaecati impedit necessitatibus, nulla, non ad ipsum illum voluptatum
                                        dignissimos beatae? Asperiores cum, qui, iure suscipit nemo praesentium iusto
                                        dignissimos ad voluptatem eum impedit accusantium temporibus nobis dicta.</p>
                                </div>
                            </div>
                        </div>
