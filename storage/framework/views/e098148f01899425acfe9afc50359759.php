        ...
        <header id="header" class="header d-flex align-items-center fixed-top shadow p-3 mb-5 bg-body">
            <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
                ...
                <a href="/" class="logo d-flex align-items-center me-auto me-xl-0">
                    <img src="<?php echo e(asset('images/icon/LOGO_GRAHA_SAMAWA_HITAM.png')); ?> " alt="">
                </a>
...
<?php /**PATH C:\Users\maret\Downloads\Graha Samawa\resources\views/landing/index.blade.php ENDPATH**/ ?>